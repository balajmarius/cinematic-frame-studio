          ...
          <div ref={ref} className="reveal">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex items-center gap-3 mt-2">
                ...
                <a href="https://www.linkedin.com/in/petru-vlad-8071521a" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-border flex items-center justify-center text-muted-foreground hover:border-gold hover:text-gold transition-colors duration-200">
